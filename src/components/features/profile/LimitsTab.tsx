...
export const LimitsTab: React.FC = () => {
  return (
    <div className="flex flex-col gap-6 w-full max-w-[1064px]">
      {/* Заголовок (#8:260: Inter Bold 28px #14171C) */}
      <h1 className="text-[28px] font-bold text-[#14171C]">
        Лимиты
      </h1>

      {/* LimitsCard (#8:287: 1064px, bg #FFFFFF, borderRadius 12px, padding 32px) */}
      <div className="w-full bg-white rounded-[12px] p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* CardResidents (#8:288) */}
